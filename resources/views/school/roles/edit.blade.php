...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary btn-sm mb-2" href="{{ route('schools.roles.index') }}"><i class="fa fa-arrow-left"></i>
                    Back</a>
            </div>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('schools.roles.update', $role->id) }}">
        @csrf
        @method('PUT')
